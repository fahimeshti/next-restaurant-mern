...
const Index = ({ orders, products }) => {
  ...
  const handleDelete = async (id) => {
    ...
    try {
      const res = await axios.delete(
        "http://esti-next-restaurant-mern.vercel.app/api/products/" + id
      );
  ...
  const handleStatus = async (id) => {
    ...
    try {
      const res = await axios.put("http://esti-next-restaurant-mern.vercel.app/api/orders/" + id, {
...
export const getServerSideProps = async (ctx) => {
  ...
  const orderRes = await axios.get("http://esti-next-restaurant-mern.vercel.app/api/orders");
